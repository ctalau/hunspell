...
- Maintain and update `plan.md` as the detailed implementation plan derived from `spec.md` phases (starting at item 12).
- Mark implementation progress directly in `plan.md` under the corresponding phase section.
